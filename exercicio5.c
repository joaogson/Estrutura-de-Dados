...
alunos* EncontreMelhorAluno( alunos *alunosInfo[], int tamanho){
    int count =0;
    printf("Buscando melhor aluno");
    ...
    alunos melhorAluno = *alunosInfo[count];
...
void CadastrarAlunos(int tamanho, alunos *a){
...
int main(){
    ...
    alunos *melhoraluno = EncontreMelhorAluno(aluno, tamanho);
